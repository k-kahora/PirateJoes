...
public class Level7 extends AbstractLevel{
    ...
    public Level7(PirateJoes pirateJoes) {
        super(pirateJoes);
    }
    ...
    public void show() {
        ...
        secondLayer = new TileEditor(StaticLevels.level7, getAssetManager().manager.get(getAssetManager().bruh));
        ...
        getFluViruses().add(new WanderVirus.Builder(character, this, collisonMaps, assetManager).fast().build());

        getFluViruses().add(new WanderVirus.Builder(character, this, collisonMaps, assetManager).wander().build());
        ...
        getFluViruses().get(0).setPosition(390, 100);
        getFluViruses().get(1).setPosition(320, 100);
        getFluViruses().get(2).setPosition(320, 130);
        getFluViruses().get(3).setPosition(80, 120);
        getFluViruses().get(4).setPosition(90, 70);
