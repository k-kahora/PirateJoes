...
public class Level2 extends AbstractLevel{
    ...
    public void show() {
        ...
        secondLayer = new TileEditor(StaticLevels.level2, getAssetManager().manager.get(getAssetManager().bruh));
        setRender();
